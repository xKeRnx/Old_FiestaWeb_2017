...
<head>
    ...
    <title><?php echo $_SITETITLE; ?> | Donate</title>
    ...
    <div class="nk-main">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2>DONATE</h2>
					<iframe src="https://api.paymentwall.com/api/ps/?key=&uid=<?php echo $_SESSION['nUserNo'];?>&widget=p10_2" width="100%" height="800" frameborder="0"></iframe>
                </div>
            </div>
