...
<head>
    ...
    <title><?php echo $_SITETITLE; ?> | About</title>
...
<body>
    ...
    <div class="nk-main">
        ...
        <div class="nk-header-title nk-header-title-sm nk-header-title-parallax-opacity">
            <div class="bg-image">
                <div style="background-image: url('assets/images/image-4.png');"></div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <h2>About US</h2>
					<br>
                    <p>We've started with KeRnOnline at 2010.</p>
					<p>The Idea was to create a Server for my Friends and after a while i just wanted to do something special.</p>
					<p>I started to create a public Server for some other guys and the server grew up very fast.</p>
					<br>
					<p>I decided to keep the server up as possible, earned money and then i bought my very first root server.</p>
					<p>Our Community grew up very fast and now we're here! We have an own network and we're sponsoring root servers for other Guys.</p>
                </div>
            </div>
