...
<head>
    ...
    <title><?php echo $_SITETITLE; ?> | TOP Playmin</title>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <h2>TOP 100 Playmin</h2>
					<br>
<?php
		echo '<center><table width="100%">';
		echo '<tr><th>#</th><th>Username</th><th>Play Time</th><th>Guild</th></tr>';
		$i = 1;
		$order = 'ORDER BY nPlayMin DESC';
		if(isset($_GET['order'])){
			switch($_GET['order']){
				case 'nEXP':
		...
		while($fetchChar = sqlsrv_fetch_array($getChar)){
			...
			echo '<tr><th>'.$i.'</th><th>'.$fetchChar['sID'].'</th><th>'.minutesToTime($fetchChar['nPlayMin']).'</th><th>'.$guild.'</th></tr>';
			$i++;
		}
		echo '</table></center>';
