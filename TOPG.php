...
<head>
    ...
    <title><?php echo $_SITETITLE; ?> | TOP Guilds</title>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <h2>TOP 100 Guilds</h2>
					<br>
<?php
		echo '<center><table width="100%">';
		echo '<tr><th>#</th><th>Name</th><th>Win</th><th>Lose</th><th>Draw</th></tr>';
		$i = 1;
		$getGuild = sqlsrv_query($conn, "SELECT TOP 100 sName, nWarWinCount, nWarLoseCount, nWarDrawCount FROM World00_Character..tGuild ORDER BY nWarWinCount DESC;", array());
		while($fetchGuild = sqlsrv_fetch_array($getGuild)){
			echo '<tr><th>'.$i.'</th><th>'.$fetchGuild['sName'].'</th><th>'.$fetchGuild['nWarWinCount'].'</th><th>'.$fetchGuild['nWarLoseCount'].'</th><th>'.$fetchGuild['nWarDrawCount'].'</th></tr>';
			$i++;
		}
		echo '</table></center>';
