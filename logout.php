...
<head>
    ...
    <title><?php echo $_SITETITLE; ?> | Logout</title>
...
<?php
	if(isset($_SESSION['nUserNo'])){
		session_destroy();
		echo '<div class="nk-info-box bg-success"><div class="nk-info-box-icon"><i class="ion-alert-circled"></i></div>Successfully logged out!</div>';
	}else{
		echo '<div class="nk-info-box bg-info"><div class="nk-info-box-icon"><i class="ion-alert-circled"></i></div>Session already destroyed!!</div>';
	}
?>
